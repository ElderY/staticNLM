...
class SequenceProbabilityTrigrams(FrequentTrigrams):
...
if __name__ == "__main__":
    ...
    TrigProb = SequenceProbabilityTrigrams().trigrams_prob_count(TrigramsModule.trig_freq, BigramsModule.bigrams_freq)
